...
realms:
  ...
  - name: realm_1
    mesh: mesh/Complete_System41_Combined_R1.exo
    use_edges: no       
    activate_aura: no
    ...
    restart:
      restart_data_base_name: restart/fullV27_41_R1.rst
